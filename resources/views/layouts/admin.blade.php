...
<body class="bg-gray-50" x-data="{ sidebarOpen: true, mobileMenuOpen: false, notifOpen: false, profileOpen: false }">
    ...
    <aside :class="sidebarOpen ? 'w-64' : 'w-20'" class="fixed left-0 top-0 h-screen bg-gradient-to-b from-slate-800 to-slate-900 text-white transition-all duration-300 z-30 shadow-xl">
        ...
        <!-- Navigation -->
        <nav class="mt-6 px-3">
            <a href="{{ route('dashboard') }}" class="flex items-center space-x-3 px-3 py-3 mb-2 bg-slate-700 rounded-lg hover:bg-slate-700 transition group">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.audit.logs') }}" class="flex items-center space-x-3 px-3 py-3 mb-2 rounded-lg hover:bg-slate-700 transition group">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
