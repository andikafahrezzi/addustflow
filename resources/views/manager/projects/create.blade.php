{{-- resources/views/manager/projects/create.blade.php --}}
@extends('layouts.manager')

@section('title', 'Buat Project')
@section('breadcrumb', 'Projects / Buat Project')
...
@section('content')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Buat Project</h1>
            <p class="text-sm text-gray-500 mt-1">Isi detail project baru</p>
        </div>
    ...
    <div class="bg-white shadow-sm rounded-xl border border-gray-100 p-5 sm:p-8 max-w-2xl">
        <form action="{{ route('manager.projects.store') }}" method="POST">
            ...
            <div class="mb-5">
                ...
                <select id="proposal-select" name="proposal_id"
            ...
            <div class="mb-5">
                ...
                <input type="number" id="estimated-value"
